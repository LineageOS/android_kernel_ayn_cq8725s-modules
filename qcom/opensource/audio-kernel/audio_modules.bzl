...
audio_modules.register(
    ...
    deps = ["//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/msm_ext_display:%b_msm_ext_display",
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/msm_ext_display:msm_ext_display_headers",
	],
)
audio_modules.register(
