...
def _define_module(target, variant):
    ...
    if target == "pineapple":
        deps.extend([
            ...
            "//vendor/ayn/cq8725s-modules/qcom/opensource/synx-kernel:{}_modules".format(tv),
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:smcinvoke_kernel_headers",
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:smmu_proxy_headers",
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:{}_smcinvoke_dlkm".format(tv),
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:{}_smmu_proxy_dlkm".format(tv),
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mmrm-driver:{}_mmrm_driver".format(tv),
        ])
    if target == "sun":
        deps.extend([
            "//vendor/ayn/cq8725s-modules/qcom/opensource/synx-kernel:synx_headers",
