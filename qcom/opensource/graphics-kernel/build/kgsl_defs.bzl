...
load("//vendor/ayn/kernel:target_variants.bzl", "get_all_la_variants")
...
def external_deps(target, variant):
    ...
    if target in [ "pineapple" ]:
        deplist = deplist + [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/hw_fence:{}_msm_hw_fence".format(tv),
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/hw_fence:hw_fence_headers"
            ]
        defconfigs = defconfigs + [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/hw_fence:defconfig"
            ]
...
def define_target_variant_module(target, variant):
    ...
    ddk_module(
        ...
        deps = [ "//vendor/ayn/kernel:all_headers" ] + ext_deps,
        includes = ["include", "."],
