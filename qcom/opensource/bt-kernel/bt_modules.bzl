...
register_bt_modules(
    ...
    config_deps = {
            ...
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:%b_smcinvoke_dlkm",
        ]
    },
    deps = [
        "//vendor/ayn/cq8725s-modules/qcom/opensource/wlan/platform:all-wlan-platform-headers",
        "//vendor/ayn/cq8725s-modules/qcom/opensource/wlan/platform:%b_cnss_utils",
    ],
)
...
register_bt_modules(
    ...
    deps = [
        ...
        "//vendor/ayn/cq8725s-modules/qcom/opensource/audio-kernel:%b_swr_dlkm",
        "//vendor/ayn/cq8725s-modules/qcom/opensource/audio-kernel:audio_headers",
    ],
)
