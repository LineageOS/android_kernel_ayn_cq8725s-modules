...
module_entry(
      ...
      config_deps = {
        ...
        "CONFIG_QCOM_SPEC_SYNC" : [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/sync_fence:%b_sync_fence",
        ],
        "CONFIG_MSM_EXT_DISPLAY" : [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mm-drivers/msm_ext_display:%b_msm_ext_display",
        ],
        "CONFIG_HDCP_QSEECOM" : [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:%b_hdcp_qseecom_dlkm"
        ],
        "CONFIG_MSM_MMRM" : [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/mmrm-driver:%b_mmrm_driver",
        ],
        "CONFIG_SMMU_PROXY" : [
            "//vendor/ayn/cq8725s-modules/qcom/opensource/securemsm-kernel:%b_smmu_proxy_dlkm",
